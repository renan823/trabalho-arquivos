...
printf "6 teste.bin 1\n1 idAttack 5889\n6 year NULO financialLoss NULO country NULO attackType NULO targetIndustry NULO defenseMechanism NULO\n1 idAttack 6845\n3 country \"GERMANY\" attackType \"SUPER SQL INJECTION\" targetIndustry \"THE BEST INDUSTRY EVER\"" | ./trabalho
printf "2 teste.bin" | ./trabalho